...
$sql3 = "select hotel_id,points,point_status from hotel_history where hotel_id=(select MAX(hotel_id) from hotel_history where id=$sessionid)";
...
{ 
  $hotel = $_POST['hotel'];
  $sql2 = "insert into hotel_history(id,hotel_name,date,points,point_status) values($sessionid,'$hotel',CURDATE(),$count + 50,'add')";
...
{ 
  $hotel = $_POST['hotel'];
  $sql4="insert into hotel_history(id,hotel_name,date,points,point_status) values($sessionid,'$hotel',CURDATE(), 0,'redeem')";
...
<!-- 			<td>
			...
			<td>
				<input class="form-control" type="text" name="points" value="<?php
